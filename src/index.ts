...
import { VectorToCanvas } from './VectorToCanvas';
...
if (!("swf2js" in window)){(function(window)
{
    ...
    var isWebGL = ((window as any).WebGLRenderingContext &&
    ...
    ActionScript.prototype.ActionFsCommand2 = function (stack, mc)
    {
        ...
        switch (method.toLowerCase()) {
            ...
            case "getdeviceid":
                ...
                break;
            case "getlanguage":
                var language = (_navigator as any).userLanguage ||
                    _navigator.language ||
                    (_navigator as any).browserLanguage ||
                    "ja-JP";
     ...
     * @constructor
     */
    var BlurFilter = function (...args) // any
    {
        var _this = this;
     ...
     * @constructor
     */
    var DropShadowFilter = function (...args) // any
    {
        var _this = this;
        BitmapFilter.call(_this);
     ...
     * @constructor
     */
    var GlowFilter = function (...args) // any
    {
        var _this = this;
        BitmapFilter.call(_this);
     ...
     * @constructor
     */
    var BevelFilter = function (...args) // any
    {
        var _this = this;
        BitmapFilter.call(_this);
     ...
     * @constructor
     */
    var GradientGlowFilter = function (...args) // any
    {
        var _this = this;
        BitmapFilter.call(_this);
     ...
     * @constructor
     */
    var GradientBevelFilter = function (...args) // any
    {
        var _this = this;
        BitmapFilter.call(_this);
    ...
    Graphics.prototype.colorStringToInt = function(str)
    {
        ...
        var ctx = canvas.getContext("2d");
        ctx.fillStyle = str;
        var color = "0x" + (ctx.fillStyle as string).substr(1);
        cacheStore.destroy(ctx);
        return color;
    };
    ...
    Stage.prototype.appendTextArea = function (textField, hitObj)
    {
        ...
        var element: any = _document.getElementById(textField.getTagName());
        if (!element) {
